...
class AddBrandView extends StatefulWidget {
  final BrandDetailModel? bObj;
  const AddBrandView({Key? key, this.bObj}) : super(key: key);

  @override
  _AddBrandViewState createState() => _AddBrandViewState();
}

class _AddBrandViewState extends State<AddBrandView> {
  ...
  @override
  void dispose() {
    Get.delete<BrandDetailViewModel>();
    super.dispose();
  }
          ...
          child: Column(
            children: [
              ...
              RoundButton(
                title: "Add Brand",
                onPressed: () {
                  _viewModel.createBrandDetail(() => Navigator.pop(context));
                },
              ),
            ],
          ),
